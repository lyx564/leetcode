...
class Solution:
    def shortestAlternatingPaths(self, n, redEdges, blueEdges):
        ...
        for e in redEdges:
            edges[e[0]].append((e[1], 0))
        for e in blueEdges:
            edges[e[0]].append((e[1], 1))
        ...
        while quene:
            temp = quene
            quene = []
            for start, color in temp:
                if result[start] == -1:
                    result[start] = level
                for e in edges[start]:
                    if color != e[1] and e not in vis:
                        vis.add(e)
                        quene.append(e)
            level += 1
        return result

...
来源：力扣（LeetCode）
链接：https://leetcode.cn/problems/liang-ge-lian-biao-de-di-yi-ge-gong-gong-jie-dian-lcof/?envType=study-plan-v2&envId=coding-interviews
...
if __name__ == '__main__':
    ...
    res = Solution().getIntersectionNode_1(headA=node1, headB=node2)
    while res:
        print(res.val)
        res = res.next
